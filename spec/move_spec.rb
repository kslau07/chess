...
describe Move do
  ...
  describe '#input_move' do
    context 'when user input is good' do
      ...
      it 'receives 2 inputs from player' do
        ...
        allow(subject).to receive(:move_valid?).and_return(true)
  ...
  describe '#move_valid?' do
    context 'when start_sq and end_sq are permitted' do
      start_sq = [1, 0]
      end_sq = [2, 0]
      ...
      it 'returns true' do
        ...
        result = subject.move_valid?(start_sq, end_sq)
